...
function page(fromTarget, pageInfo, pageTarget) {
	...
	pageStr += "<li onclick=\"setPageIndex("+1+",\'"+fromTarget+"\')\"><a href='javascript:void(0);' style='color: #ee4735;'>首页</a></li>";
	var start = 1;
	var end = 1;
	...
	for (var index=start;index<=end;index++) {
		if (parseInt(pageInfo.currentPage) == index) {
			pageStr += "<li class='active' style='background-color:#ee4735;'><a href='javascript:void(0);' style='color: #fff;'>"+index+"</a></li>";
		} else {
			pageStr += "<li onclick=\"setPageIndex("+index+",\'"+fromTarget+"\')\"><a href='javascript:void(0);' style='color: #ee4735;'>"+index+"</a></li>";
		}
	}
	pageStr += "<li onclick=\"setPageIndex("+pageInfo.pageCount+",\'"+fromTarget+"\')\"><a href='javascript:void(0);' style='color: #ee4735;'>末页</a></li>";
	pageStr += "<li><a href='javascript:void(0);' style='cursor: not-allowed; color: #ee4735;'>共 "+pageInfo.recordCount+" 条记录</a></li>";
	pageStr += "</ul>";
