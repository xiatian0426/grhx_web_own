...
<div class="r_box" style="margin-bottom: 10px;">
	<table width="100%" cellpadding="0" cellspacing="0" class="table-bordered" style="border: 2px solid #C5021B;">
		<tr style="height:30px;background-color: #C5021B;">
			<td width="76%" align="left" style="padding-left:60px; font-size: 17px;font-weight: bold;border: 1px solid #C5021B;color: #fff;">
				标题
			</td>
			<td width="8%" align="center" style="font-size: 17px;font-weight: bold;border: 1px solid #C5021B;color: #fff;">
				地区
			</td>
			<td width="8%" align="center" style="font-size: 17px;font-weight: bold;border: 1px solid #C5021B;color: #fff;">
				类型
		...
		<c:forEach items="${page.result}" var="messageData" varStatus="count">
			<tr>
				<td align="left"  title="${messageData.title}" style="border: 1px dashed #C5021B;">
